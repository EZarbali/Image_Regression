...
class LightingModel(pl.LightningModule): 
    ...
    def on_train_epoch_end(self):
        ...
        self.log("avg_train_loss", avg_train_loss, on_epoch=True, on_step=False, sync_dist=True)
    ...
    def on_validation_epoch_end(self):
        ...
        self.log("avg_val_loss", avg_val_loss, on_epoch=True, on_step=False, sync_dist=True)
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.AdamW(params=self.parameters(), lr=self.args.lr, betas=(self.args.beta1, self.args.beta2), weight_decay=self.args.weight_decay)
    ...
    def _create_dataloader(self, mode: str, **kwargs) -> DataLoader: 
        ...
        return DataLoader(dataset, self.args.batch_size, shuffle=True, pin_memory=self.args.pin_memory)
    ...
    def _dataset_handler(self, mode): 
        if mode == "train": 
            ...
            raise ValueError(f"Mode {mode} is not known. Choose between train, val or test.")
