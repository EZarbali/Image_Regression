...
class CNN_Model(nn.Module):
    def __init__(self, cfg: DictConfig):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=3, stride=1), nn.BatchNorm2d(64), nn.ReLU()
        )
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(64, 128, kernel_size=3, stride=1), nn.BatchNorm2d(128), nn.ReLU()
        )
        self.layer4 = nn.Sequential(
            nn.Conv2d(128, 128, kernel_size=3, stride=1), nn.BatchNorm2d(128), nn.ReLU()
        )
